...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private void initMediaSession() throws RemoteException {
        ...
        mediaSession = new MediaSessionCompat(getApplicationContext(),"AudioPlayer", null, null);
    ...
    private void updateMetaData() {
        Bitmap albumArt = BitmapFactory.decodeResource(getResources(),
                R.drawable.album_viejos_komodines); //replace with medias albumArt
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_fast_forward_black_24dp); //replace with your own image
